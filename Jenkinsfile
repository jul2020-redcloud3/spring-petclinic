...
"""
  ...
  environment {
    ...
    GITHUB_GROUP = "jul2020-redcloud3"
    GITHUB_PROJECT = "spring-petclinic"
    GITHUB_PROJECT_URL = "https://github.com/jul2020-redcloud3/spring-petclinic"
    DEVCLOUD_REGISTRY_ADDRESS = "docker-nexus.mgt.jul2020.perspectatechdemos.com"
    QUAY_REGISTRY_ADDRESS = "quay-quay-enterprise.apps.jul2020.perspectatechdemos.com"
    ...
    MATTERMOST_CHANNEL = "jul2020-redcloud3-spring-petclinic"
    MATTERMOST_WEBHOOK = "https://mattermost.mgt.jul2020.perspectatechdemos.com/hooks/qs1iby1u1fda3dmcsjez4qskyr"
    ARTIFACTORY_URL = "https://artifactory.mgt.jul2020.perspectatechdemos.com"
    NEXUS_ARTIFACT_URL = "https://nexus.mgt.jul2020.perspectatechdemos.com/#browse/search/docker"
    SONARQUBE_URL = "https://sonarqube.mgt.jul2020.perspectatechdemos.com"
    // we set this for now as there is some weirdness related to BUILD_URL env variable
    // definitely not best practice
    BUILD_URL = "https://jenkins.mgt.jul2020.perspectatechdemos.com/job/jul2020-redcloud3/job/spring-petclinic/job/${BRANCH_NAME}/${BUILD_NUMBER}"
    DEV_DEPLOYMENT_URL = "https://jul2020-redcloud3-spring-petclinic-${BRANCH_NAME}.dev.jul2020.perspectatechdemos.com"
    TEST_DEPLOYMENT_URL = "https://jul2020-redcloud3-spring-petclinic-${BRANCH_NAME}.test.jul2020.perspectatechdemos.com"
    PROD_DEPLOYMENT_URL = "https://jul2020-redcloud3-spring-petclinic-${BRANCH_NAME}.prod.jul2020.perspectatechdemos.com"
  ...
  stages {
    stage('Build') {
      steps {
        ...
        container('maven') {
          sh 'env; pwd;ls -al'
	  checkout changelog: false, poll: false, scm: [$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'jul2020-redcloud3-token', url: "${GITHUB_PROJECT_URL}.git"]]] 
          dir('.') {
            sh 'ls -al'
            sh 'mvn compile'
          }
